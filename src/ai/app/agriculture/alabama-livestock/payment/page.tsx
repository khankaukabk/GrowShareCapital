                        ...
                        <div className="p-8 md:p-10 bg-[#FAFAF9] border-b border-stone-200">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center">
                                    <span className="text-neutral-500 text-sm font-light">Principal ({numberOfShares} Shares)</span>
                                    <span className="font-serif text-lg text-neutral-900">${investmentAmount.toLocaleString()}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-neutral-400 text-xs font-light">Card Fee (2.9% + 0.30)</span>
                                    <span className="text-neutral-400 font-mono text-xs">+${processingFee.toFixed(2)}</span>
                                </div>
                                <Separator className="bg-stone-200 my-4" />
                                <div className="flex justify-between items-center">
                                    <span className="font-bold text-neutral-900 uppercase tracking-widest text-xs">Total Charge</span>
                                    <span className="font-serif text-3xl text-neutral-900">${totalCharge.toFixed(2)}</span>
                                </div>
                            </div>
                        </div>
