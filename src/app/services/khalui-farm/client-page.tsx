        ...
        <div className="bg-[#F4F4F2] text-[#141F14] selection:bg-[#D4AF37]/30 selection:text-[#141F14] min-h-screen overflow-x-hidden font-sans m-0 p-0 border-none">
            ...
            <div id="khalui-wrapper">
                ...
                <section className="relative min-h-[100svh] flex flex-col justify-end pt-32 pb-20 md:pb-32 px-6 md:px-12 border-b border-[#141F14]/10 overflow-hidden">
                    ...
                    {/* NEW: Back Button on Hero (Links to /services) */}
                    <div className="absolute top-0 left-0 z-20 p-8 md:p-12">
                        <a href="/services" className="group flex items-center gap-3 text-[#141F14] hover:text-[#D4AF37] transition-colors duration-300">
                            <div className="w-10 h-10 rounded-full border border-[#141F14]/20 flex items-center justify-center bg-[#F4F4F2]/50 backdrop-blur-md group-hover:border-[#D4AF37] transition-all">
                                <ArrowLeft className="w-4 h-4" />
                            </div>
                            <span className="text-[10px] uppercase tracking-[0.2em] font-bold opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 font-sans hidden md:block">
                                Return to Services
                            </span>
                        </a>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto bg-white border border-[#141F14]/5 p-8 md:p-20 rounded-sm relative overflow-hidden shadow-lg shadow-[#141F14]/5">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <a href="/services/khalui-farm/harvest-calendar" className="bg-[#F9F9F7] border border-[#141F14]/5 p-8 flex flex-col gap-6 hover:border-[#D4AF37]/40 transition-all duration-500 group cursor-pointer block">
                                    <div className="flex justify-between items-start">
                                        <Calendar className="w-6 h-6 text-[#D4AF37] opacity-80" />
                                        <span className="text-[8px] bg-[#D4AF37]/10 text-[#D4AF37] px-2 py-1 rounded-sm uppercase tracking-widest font-bold font-sans">LIVE PAGE</span>
                                    </div>
                                    <div>
                                        <h4 className="text-[#141F14] font-serif text-xl mb-2 group-hover:text-[#D4AF37] transition-colors">Harvest Calendar</h4>
                                        <div className="text-[9px] uppercase tracking-[0.2em] text-[#141F14] flex items-center gap-3 group-hover:gap-5 transition-all font-bold border-b border-[#141F14]/10 pb-2 w-fit">
                                            View Calendar <ArrowRight size={12} className="text-[#D4AF37]"/>
                                        </div>
                                    </div>
                                </a>
                                <a href="/services/khalui-farm/wholesale" className="bg-[#F9F9F7] border border-[#141F14]/5 p-8 flex flex-col gap-6 hover:border-[#D4AF37]/40 transition-all duration-500 group cursor-pointer block">
                                    <div className="flex justify-between items-start">
                                        <ShoppingBasket className="w-6 h-6 text-[#D4AF37] opacity-80" />
                                        <span className="text-[8px] bg-[#D4AF37]/10 text-[#D4AF37] px-2 py-1 rounded-sm uppercase tracking-widest font-bold font-sans">CATALOG PAGE</span>
                                    </div>
                                    <div>
                                        <h4 className="text-[#141F14] font-serif text-xl mb-2 group-hover:text-[#D4AF37] transition-colors">Wholesale Meat</h4>
                                        <div className="text-[9px] uppercase tracking-[0.2em] text-[#141F14] flex items-center gap-3 group-hover:gap-5 transition-all font-bold border-b border-[#141F14]/10 pb-2 w-fit">
                                            View Cuts & Pricing <ArrowRight size={12} className="text-[#D4AF37]"/>
                                        </div>
                                    </div>
                                </a>
                            </div>
                ...
                {/* --- 8. LUXURY FOOTER --- */}
                <footer className="py-24 md:py-32 px-6 bg-[#0B0C0B] text-[#F4F4F2] border-t border-white/5 relative overflow-hidden">
                    {/* Background Texture/Gradient */}
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#D4AF37]/5 rounded-full blur-[100px] pointer-events-none" />

                    <div className="max-w-5xl mx-auto text-center relative z-10">
                        {/* Heading */}
                        <h2 className="font-serif text-5xl md:text-8xl text-white mb-8 italic">Taste the Difference.</h2>
                        <p className="font-sans text-neutral-400 mb-16 max-w-lg mx-auto leading-loose text-sm font-light">
                            Ready to secure your share of the harvest? <br/>
                            Membership spots are limited for the upcoming season.
                        </p>
                        ...
                        <div className="flex flex-col items-center gap-6">
                            {/* Contact Socials */}
                            <div className="flex justify-center gap-8 mb-4 opacity-60 hover:opacity-100 transition-opacity">
                                <a href={WHATSAPP_LINK} className="hover:text-[#D4AF37] transition-colors"><Phone size={20}/></a>
                                <a href="#" className="hover:text-[#D4AF37] transition-colors"><Instagram size={20}/></a>
                            </div>

                            {/* Copyright & EST Date Combined */}
                            <span className="text-[9px] uppercase tracking-[0.2em] text-neutral-500 font-sans">
                                EST. 2022  •  © 2026 {LOGO_TEXT}. All Rights Reserved.
                            </span>

                            {/* GROWSHARE BRANDING */}
                            <div className="flex items-baseline justify-center gap-2 mt-4 opacity-80">
                                <span className="font-serif italic text-neutral-400 text-lg">A</span>
                                <span className="font-sans font-bold text-[#D4AF37] tracking-[0.15em] uppercase text-sm">GrowShare Capital</span>
                                <span className="font-serif italic text-neutral-400 text-lg">Company</span>
                            </div>
                        </div>
                    </div>
                </footer>
