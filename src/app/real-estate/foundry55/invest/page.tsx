...
const CheckoutForm = ({ clientSecret, email, totalCharge, setPaymentSuccess }: { clientSecret: string, email: string, totalCharge: number, setPaymentSuccess: (s: boolean) => void }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    const { error: confirmError } = await stripe.confirmPayment({
      elements,
      confirmParams: {
        return_url: `${window.location.origin}/real-estate/foundry55/invest?success=true`,
        receipt_email: email,
      },
...
export default function Foundry55InvestmentPage() {
    ...
    const handleCustomerSubmit = async (e: React.FormEvent) => {
        ...
        const intentResult = await createInvestmentPaymentIntent({
            ...
            investmentDetails: { 
                ...
                investmentAmount, 
                totalCharge,
                project: 'Foundry55 Workforce Housing'
            }
        });
  ...
  return (
    <div className="bg-[#F9F9F7] min-h-screen text-neutral-900 font-sans selection:bg-neutral-900 selection:text-white">
      ...
      <header className="relative w-full h-[45vh] flex items-center justify-center bg-[#121212] overflow-hidden">
         <Image
            src="https://i.imgur.com/Lyfqp5G.jpeg"
         ...
         <div className="relative z-20 text-center px-6">
            <FadeIn>
                ...
                <p className="text-white/60 font-serif italic text-lg">Foundry55 Allocation</p>
            </FadeIn>
         </div>
      </header>
        ...
        <div className="max-w-3xl mx-auto">
            ...
            {paymentSuccess ? (
                <FadeIn>
                    <div className="bg-white border border-stone-200 shadow-xl p-12 md:p-16 text-center">
                        ...
                        <p className="text-neutral-500 font-light mb-10 leading-relaxed max-w-md mx-auto">
                            Thank you, {name}. Your investment in Foundry55 has been processed successfully. An official receipt has been sent to {email}.
                        </p>
                        <Button 
                ...
                <div className="space-y-8">
                        ...
                        <FadeIn>
                            <div className="bg-white border border-stone-200 shadow-sm p-8 md:p-12">
                                <div className="flex items-center justify-between border-b border-stone-100 pb-6 mb-8">
                                    <h3 className="text-[10px] uppercase tracking-[0.25em] font-bold text-neutral-400">01 / Configuration</h3>
                                    <span className="text-[10px] uppercase tracking-widest text-neutral-300">Start</span>
                                </div>
                                ...
                                <form onSubmit={handleCustomerSubmit} className="space-y-12">
                                    ...
                                    <div className="text-center py-10 bg-[#FAFAF9] border border-stone-100">
                                        <Label className="text-[10px] uppercase tracking-[0.2em] text-neutral-400 block mb-8">
                                            Allocation Volume (${SHARE_PRICE.toLocaleString()} / Share)
                                        </Label>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-3">
                                            <Label htmlFor="name" className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 font-bold">Investor Name</Label>
                                            <Input 
                                                id="name" 
                                                value={name} 
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="email" className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 font-bold">Email Address</Label>
                                            <Input 
                                                id="email" 
                                                type="email" 
                                                value={email} 
                            ...
                            <div className="bg-white border border-stone-200 shadow-sm">
                                ...
                                <div className="p-8 md:p-10 bg-[#FAFAF9] border-b border-stone-200">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between items-center"><span className="font-bold uppercase tracking-widest text-xs">Total Authorized</span><span className="font-serif text-3xl">${totalCharge.toFixed(2)}</span></div>
                                    </div>
                                </div>
                    ...
                    {/* --- CONCIERGE / WIRE TRANSFER SECTION --- */}
                    <FadeIn delay={0.2}>
                        <div className="mt-8 p-8 md:p-10 border border-stone-200 bg-white text-center rounded-sm shadow-sm relative overflow-hidden">
                            ...
                            <p className="text-sm text-neutral-500 font-light mb-8 max-w-md mx-auto leading-loose">
                                To avoid the 2.9% card processing fee, we accept direct transfers via Zelle, Venmo, or Wire. Contact our team to arrange a secure transfer.
                            </p>
                            
                            <div className="flex justify-center">
                                <a 
                                  href="https://wa.me/12144736888?text=I'd%20like%20to%20invest%20in%20Foundry55%20via%20direct%20transfer." 
                                  target="_blank" 
                    ...
                    <div className="text-center pt-12">
                        <Link href="/real-estate/foundry55" className="group inline-flex items-center gap-2 text-[10px] text-neutral-400 uppercase tracking-widest hover:text-neutral-900 transition-colors">
